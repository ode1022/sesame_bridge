...
"""
            ...
            body += """${toggled}<form action="./" method="post"><input type="hidden" name="web" value="1"><div class="mx-auto" style="width: max-content;margin-top: 200px"><input type="submit" name="submit" value="Sesameトグル開閉" class="btn btn-primary"></div></form>"""
